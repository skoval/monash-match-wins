...
- .monash-orange2[Other feature:]consider the variation of player's ability in the different surface courts
...
- However, the final model data is constructed by filtering the top 100 players from atpworldtour.com and wtatennis.com
...
`r icon::fontawesome("smile-wink")` Nadal has won 13 French Opens (the clay grand slam) and has a chance to win his 14th against with Djokovic this week.
---
...
- Further exploration:
 ...
 - Additional factors: player ranking, Elo scores,...
